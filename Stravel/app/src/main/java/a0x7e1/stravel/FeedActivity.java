...
public class FeedActivity extends AppCompatActivity {
    ...
    private static String TAG = "phptest_FeedActivity";
    ...
    private TextView mTextViewResult;ListView mlistView;
    String mJsonString;
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(FeedActivity.this,
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new ExtendedSimpleAdapter(
                    FeedActivity.this, mArrayList, R.layout.activity_cert,
                    new String[]{TAG_uploadID,,TAG_userName,TAG_uploadDate,TAG_uploadContent},
                    new int[]{R.id.uploadID, R.id.userName, R.id.uploadDate, R.id.uploadContent}
            );
